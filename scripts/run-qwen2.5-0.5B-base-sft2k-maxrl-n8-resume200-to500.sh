...
CKPT_ARGS=(
   ...
   --load /data3/private/lwz/slime-runs/qwen25_05b_base_sft2k_maxrl_n8_curve200/
   --save /data3/private/lwz/slime-runs/qwen25_05b_base_sft2k_maxrl_n8_curve500/
   --save-interval 25
)
...
GRPO_ARGS=(
   ...
   --custom-advantage-function-path custom_advantages.maxrl.compute_maxrl_advantages
   --entropy-coef 0.00
   --eps-clip 0.2
   --eps-clip-high 0.28
)
